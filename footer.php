	...
	<footer id="colophon" role="contentinfo">
		...
		<?php if($options['themonic_credit_link'] == '1') { // for removing credit link () ?>
		        <?php if ( isset ($options['themonic_affiliate']) && $options['themonic_affiliate'] !== '' ): ?>
					<a href="http://themonic.com/iconic-one-pro/?ap_id=<?php echo $options['themonic_affiliate']; ?>">Iconic One Pro</a> Theme | Powered by <a href="http://wordpress.org">Wordpress</a>
					  <?php else:?>
