...
function themonic_body_class( $classes ) {
	...
	if ( is_page_template( 'page-templates/full-width.php' ) || is_page_template( 'page-templates/no-title-full-width.php' ) || is_page_template( 'page-templates/page-date-bar-fullwidth.php' ) )
		$classes[] = 'full-width';
